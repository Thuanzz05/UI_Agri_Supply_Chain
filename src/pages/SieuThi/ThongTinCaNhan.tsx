...
import { PhoneOutlined, MailOutlined, HomeOutlined, SaveOutlined, ShoppingOutlined, FacebookOutlined } from '@ant-design/icons';
...
const ThongTinCaNhan: React.FC = () => {
  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      await apiService.updateSupermarketInfo(user.maSieuThi, buildSocialUpdatePayload(values));
